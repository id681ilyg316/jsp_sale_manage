	...
	*/
	public void open() 
	{
		 String driver = "com.mysql.jdbc.Driver"; 
		    ...
		    String url = "jdbc:mysql://www.icodedock.com:3306/sale_manage?characterEncoding=gb2312&amp;mysqlEncoding=gb2312";

		    // MySQL配置时的用户名
		    String user = "sale_manage"; 

		    // MySQL配置时的密码
		    String password = "sale_manage"; 
